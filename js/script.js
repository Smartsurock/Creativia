...
$(document).ready(function () {
	$(".spoler__head").click(function (event) {
		if ($(".spoler").hasClass("single")) {
			$(".spoler__head").not($(this)).removeClass("active");
			$(".spoler__body").not($(this).next()).slideUp(300);
		}
		$(this).toggleClass("active").next().slideToggle(300);
	});
	$(".spoler__head:first").addClass("active");
	$(".spoler__body").not(":first").hide();
});
//========================================================
//Tabs
...
// 		document.querySelectorAll(".tabs").forEach((child) => child.classList.remove("active"));
